...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<nav class="flex justify-center my-6 mt-16"><ul class="steps"><a href="/login" class="step step-primary" data-svelte-h="svelte-g5g2k4">Sign In</a> <a href="/login/username" class="${[
    "step",
